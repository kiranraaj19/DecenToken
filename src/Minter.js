...
const Minter = (props) => {
  ...
  const onMintPressed = async () => {
    ...
    if (success) {
      ...
      setDescription("");
      setURL("");
      window.location.assign('https://decentoken-crustapp.herokuapp.com/');
    }
  };
    ...
    <button id="walletButton" className = "h-100" onClick={connectWalletPressed}>
     ...
     <br></br>
      ...
      <div class="rounded-social-buttons">
                        <a class="social-button linkedin" href="https://www.linkedin.com/in/kiranraaj-sekar-a950081b9/" target="_blank"><i class="fab fa-linkedin"></i></a>
                        <a class="social-button instagram" href="https://www.instagram.com/__kiranraaj" target="_blank"><i class="fab fa-instagram"></i></a>
                    </div>
    </footer>
